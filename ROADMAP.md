...
| ------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| §5.5 handover assert at **71ms**                                               | Budget is **110ms**, deliberately 1.4× the worst figure observed in cycle 000b, under stated conditions                                                                          | Asserting at worst-observed guarantees flake. Budget is 110ms production. `next dev` stays unbudgeted, and the "roughly 4×" ratio this row originally carried is **withdrawn** — measured under throttling it is roughly 84×, per `QA-CONTRACT.md`, so the quantity was never a fixed multiple |
...
Verified against `origin/main` at commit `b486c59`, not assumed.

- **7 of 21 components** shipped: Badge, Button, Card, Checkbox, Input, Label, Separator.
- **132 tests across 18 files**, green, plus **64 Playwright tests across 5 spec families**. All five
